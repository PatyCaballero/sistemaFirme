class ClientesController < ApplicationController
  ...
  private
    ...
    def cliente_params
      params.require(:cliente).permit(:nombre, :num_ruc, :telefono, :direccion, :estado, :email, :gerente, :rubro, :sucursales, :descripcion, :fechaInicio,)
    end
end
