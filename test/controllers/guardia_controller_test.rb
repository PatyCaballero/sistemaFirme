...
class GuardiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guardium" do
    assert_difference('Guardium.count') do
      post guardia_url, params: { guardium: { apellido: @guardium.apellido, direccion: @guardium.direccion, fechaNacimiento: @guardium.fechaNacimiento, nombre: @guardium.nombre, numDocumento: @guardium.numDocumento, telefono: @guardium.telefono } }
    end
  ...
  test "should update guardium" do
    patch guardium_url(@guardium), params: { guardium: { apellido: @guardium.apellido, direccion: @guardium.direccion, fechaNacimiento: @guardium.fechaNacimiento, nombre: @guardium.nombre, numDocumento: @guardium.numDocumento, telefono: @guardium.telefono } }
